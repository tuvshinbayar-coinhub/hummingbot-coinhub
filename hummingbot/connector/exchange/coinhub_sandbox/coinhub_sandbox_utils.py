...
class CoinhubSandboxConfigMap(BaseConnectorConfigMap):
    connector: str = Field(default="coinhub_sandbox", const=True, client_data=None)
    ...
    coinhub_client_id_prefix: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your CoinhubSandbox client id prefix",
            is_secure=False,
            is_connect_key=True,
            prompt_on_new=True,
        )
    ...
    class Config:
        title = "coinhub_sandbox"


KEYS = CoinhubSandboxConfigMap.construct()
